...
<html>
<head>
    <title>Laporan Kas Keluar Bulan <?= $nama_bulan . " " . $tahun ?></title>
    <style>
      @media print {
  .no-print {
...
<div class="kop-laporan" style="text-align: center;">
  ...
  <div style="font-weight: bold; font-size: 18px; margin-top: -12px;">
   <h3><u>LAPORAN KAS KELUAR BULAN <?= strtoupper($nama_bulan . " " . $tahun) ?></u></h3>
  </div>
</div>
    </p>
</div>
...
<p><strong>Total Kas Keluar Bulan Ini: Rp <?= number_format($total, 0, ',', '.') ?></strong></p>
<div class="ttd">
    <div>
